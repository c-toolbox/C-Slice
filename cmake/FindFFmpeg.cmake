...
macro(find_component _component _pkgconfig _library _header)
  ...
  if(${_component}_LIBRARIES AND NOT PC_LIB${_component}_LIBDIR)
    cmake_path(GET ${_component}_LIBRARIES PARENT_PATH PC_LIB${_component}_LIBDIR)
  endif()
  ...
  find_path(${_component}_INCLUDE_DIRS ${_header}
    HINTS
      ...
      ${PC_LIB${_component}_LIBDIR}/../include
      ${PC_LIB${_component}_LIBRARY_DIRS}../include
    PATH_SUFFIXES
      ffmpeg
  )
